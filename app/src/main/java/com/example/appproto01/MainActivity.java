...
public class MainActivity extends Form implements HandlesEventDispatching {
    ...
    protected void $define() {
        ...
        FindDeviceButton.BackgroundColor(COLOR_LTGRAY);
        ...
        HorizontalArrangement2.BackgroundColor(Color.parseColor("#72bdff"));
        ...
        HorizontalArrangement3.BackgroundColor(Color.parseColor("#40a5ff"));
        ...
        HorizontalArrangement4.BackgroundColor(Color.parseColor("#0d8dff"));
